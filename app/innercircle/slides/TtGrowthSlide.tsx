  ...
  const handleGenerate = async (e?: React.FormEvent) => {
    ...
    try {
      const ctx = tableRows
        .map(
          (r) =>
            `${r.month}: Posts=${r.post_count}, Profile Views=${r.profile_views}, Followers Growth=${r.followers_growth}, Views=${r.views}, Engagement=${r.engagement}, Avg Watch=${r.avg_watch_time}`,
        )
        .join('\n');
